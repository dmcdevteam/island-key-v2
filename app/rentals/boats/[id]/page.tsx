  ...
  return (
    <div className="min-h-screen bg-cream pb-28">
      ...
      <div className="px-4 mt-4">
        ...
        <div className="border-t border-border-light mt-4 pt-4 pb-6 text-center">
          <p className="text-[13px] text-gray-400 mb-2">Questions about this boat?</p>
          <a
            href="https://wa.me/306974176759?text=Hi%2C%20I%20need%20help%20with%20a%20boat%20rental%20in%20Crete"
            target="_blank"
